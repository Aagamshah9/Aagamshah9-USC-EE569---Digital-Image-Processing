...
N = 558;
I_new(2:356+1,2:315+1)=I;      % Center of an image
I_new(1,2:315+1)=I(2,:);     % Upper Row
I_new(356+2,2:315+1)=I(356-1,:); % Lower Row
I_new(2:356+1,1)=I(:,2);     % Leftmost Column
I_new(2:356+1,315+2)=I(:,315-1); % Rightmost Column 
F = I_new;
M = zeros(358,317);
flag = true;
G = zeros(358,317);
