...
Original file is located at
    https://colab.research.google.com/drive/1CqwWRxkvGj392MEGYHqm0-11bW5xPeYA
"""

from google.colab import drive
drive.mount('/content/drive/')

!ls "/content/drive/My Drive/EE 569_HW 6"

cd /content/drive/My Drive/EE 569_HW 6
...
Xtrain1,Xtest1, Ytrain1 , Ytest1 = train_test_split(output_1, label_train, test_size = 0.875, random_state = 0, stratify = label_train)
...
#Cross Entropy2
from cross_entropy import Cross_Entropy
Xtrain2,Xtest2, Ytrain2 , Ytest2 = train_test_split(output_2, label_train, test_size = 0.875, random_state = 0, stratify = label_train)
...
#Cross Entropy3
from cross_entropy import Cross_Entropy
Xtrain3,Xtest3, Ytrain3 , Ytest3 = train_test_split(output_3, label_train, test_size = 0.875, random_state = 0, stratify = label_train)
temp3 = Xtrain3.reshape((len(Xtrain3), -1))
...
for i in range((temp3.shape[-1])):
  output3Feature[i] = CE.KMeans_Cross_Entropy(temp3[:,i].reshape(-1,1), Ytrain3)
...
slice1 = idx1[:4018]
output_1 = Xtrain1.reshape(len(Xtrain1),-1)
...
slice2 = idx2[:2763]
output_2 = Xtrain2.reshape(len(Xtrain2),-1)
...
slice3 = idx3[:262]
output_3 = Xtrain3.reshape(len(Xtrain3),-1)
...
Xtrain,Xtest, Ytrain , Ytest = train_test_split(data_train, label_train, test_size = 0.875, random_state = 0, stratify = label_train)

from sklearn.ensemble import RandomForestClassifier
# create regressor object 
regressor = RandomForestClassifier(n_estimators = 100, random_state = 0)
# fit the regressor with x and y data 
regressor.fit(Lag_, Ytrain) 
