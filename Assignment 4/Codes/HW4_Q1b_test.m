...
[idx1,C] = kmeans(E_Final,4); % 15-D
[idx2,C] = kmeans(Yt,4); % 3-D
%% Support Vector Machine %% 

% First run the HW4_Q1b_train then HW4_Q1b_test and then run the following command
% label = predict(Mdl,Yt);

%% Random Forest Classifier %%

% First run the HW4_Q1b_train then HW4_Q1b_test and then run the following command
% ref = Mdl,predict(Mdl,Yt)